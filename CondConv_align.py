...
class CondConv3D(_ConvNd):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        routing_channels = in_channels + embeddings
    ...
    def forward(self, inputs, embeddings=None):
        ...
        routing_weights = self._routing_fn(pooled_inputs, embeddings)
...
#             routing_weights = self._routing_fn(pooled_inputs, embeddings[idx])
